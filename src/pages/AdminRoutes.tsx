...
const LicensingPage = lazy(() => import("@/pages/admin/LicensingPage"));
...
const AdminRoutes = (
  ...
  return (
    <Routes>
      <Route path="/" element={
        <ProtectedRoute requiredRole="booking-manager" loginPath="/login-selection" unauthorizedComponent={<AdminUnauthorizedComponent />}>
      ...
      <Route path="/facilities" element={
        <ProtectedRoute requiredRole="org-admin" loginPath="/login-selection" unauthorizedComponent={<AdminUnauthorizedComponent />}>
          <Suspense fallback={<AdminPageLoader />}>
      ...
      <Route path="/tenants" element={
        <ProtectedRoute requiredRole="super-admin" loginPath="/login-selection" unauthorizedComponent={<AdminUnauthorizedComponent />}>
          <Suspense fallback={<AdminPageLoader />}>
            <AdminLayout><TenantManagementPage /></AdminLayout>
          </Suspense>
        </ProtectedRoute>
      } />
      <Route path="/licensing" element={
        <ProtectedRoute requiredRole="super-admin" loginPath="/login-selection" unauthorizedComponent={<AdminUnauthorizedComponent />}>
          <Suspense fallback={<AdminPageLoader />}>
            <AdminLayout><LicensingPage /></AdminLayout>
          </Suspense>
        </ProtectedRoute>
      } />
      <Route path="/feature-flags" element={
        <ProtectedRoute requiredRole="tenant-admin" loginPath="/login-selection" unauthorizedComponent={<AdminUnauthorizedComponent />}>
          <Suspense fallback={<AdminPageLoader />}>
            <AdminLayout><FeatureFlagsPage /></AdminLayout>
          </Suspense>
        </ProtectedRoute>
      } />
    </Routes>
