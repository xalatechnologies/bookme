...
const initialFacilities: readonly IFacility[] = [
  {
    ...
    address: "Hauges gate 100, 3019 Drammen",
    capacity: 200,
    pricePerHour: 850,
  ...
  },
  {
    ...
    type: "Kulturhus",
    location: "Strømsø",
    address: "Strømsø torg 4, 3044 Drammen",
    capacity: 150,
    pricePerHour: 1200,
  ...
  },
  {
    ...
    type: "Fotballbane",
    location: "Spiralen",
    address: "Eivind Olsens vei, 3016 Drammen",
    capacity: 50,
    pricePerHour: 650,
  ...
  },
  {
    ...
    type: "Svømmehall",
    location: "Konnerud",
    address: "Kreklingveien 12, 3030 Drammen",
    capacity: 80,
    pricePerHour: 950,
  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        getPublishedFacilities: (): readonly IFacility[] => {
          return get().facilities.filter((facility) => facility.status === "published");
        },
        
        getAdminFacilities: (): readonly IFacility[] => {
          return get().facilities;
        },
      }),
      {
        name: "facility-store",
        // Only persist the facilities data, not the functions
