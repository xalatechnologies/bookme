...
// Initial mock notifications for users
const initialNotifications: readonly INotification[] = [
  {
    id: "1",
    type: "success",
    title: "notifications.types.booking_confirmed",
  ...
  },
  {
    id: "2",
    type: "info",
    title: "notifications.types.booking_reminder",
  ...
  },
  {
    id: "3",
    type: "warning",
    title: "notifications.types.booking_cancelled",
...
const UserNotificationBell = (_props: IUserNotificationBellProps): JSX.Element => {
  ...
  const {
    ...
    markAllAsRead,
    setIsOpen,
  } = useNotifications(initialNotifications, 'userNotifications');
