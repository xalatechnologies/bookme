  ...
  const types = [
    {
      ...
      label: t("booking:booking_types.one_time_label"),
      description: t("booking:booking_types.one_time_description"),
      icon: Calendar,
    },
    {
      id: "recurring" as BookingType,
      label: t("booking:booking_types.recurring_label"),
      description: t("booking:booking_types.recurring_description"),
      icon: Repeat,
    },
  ];
      ...
      {types.map((type) => {
        ...
        return (
          <Button
            ...
            aria-label={t("booking:booking_types.select_label", {
              type: type.label,
            })}
          >
            <Icon
