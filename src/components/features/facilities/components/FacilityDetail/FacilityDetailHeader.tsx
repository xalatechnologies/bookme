        ...
        <div className="hidden lg:flex flex-col gap-4">
          ...
          {facility.images.length > 3 && (
            <button className="relative overflow-hidden rounded-xl h-full bg-gray-900/80 flex items-center justify-center text-white font-medium hover:bg-gray-900/90 transition-colors">
              +{facility.images.length - 3} {t('facility:header.more_images')}
            </button>
          )}
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        <div className="flex-1">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-gray-500">({facility.reviewCount} {t('facility:header.reviews')})</span>
                </div>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-6 text-gray-600 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{t('facility:header.capacity_label', { capacity: facility.capacity })}</span>
            </div>
          </div>
        ...
        <div className="flex gap-3 lg:flex-col">
          ...
          >
            ...
            {isFavorited ? t('facility:header.remove_from_favorites') : t('facility:header.add_to_favorites')}
          </Button>
